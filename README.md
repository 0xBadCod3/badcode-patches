...
[![GitHub Release](https://img.shields.io/github/v/release/0xBadCod3/badcode-patches?style=for-the-badge&logo=github)](https://github.com/0xBadCod3/badcode-patches/releases)
[![License](https://img.shields.io/github/license/0xBadCod3/badcode-patches?style=for-the-badge)](LICENSE)
[![GitHub Stars](https://img.shields.io/github/stars/0xBadCod3/badcode-patches?style=for-the-badge)](https://github.com/0xBadCod3/badcode-patches/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/0xBadCod3/badcode-patches?style=for-the-badge)](https://github.com/0xBadCod3/badcode-patches/issues)
...
👉 **[Add to Morphe](https://morphe.software/add-source?github=0xBadCod3/badcode-patches)**
...
3. Tap **Add Source** and paste the repository URL:
   ```text
   https://github.com/0xBadCod3/badcode-patches
   ```
...
1. Go to the **[Releases](https://github.com/0xBadCod3/badcode-patches/releases)** page.
...
git clone https://github.com/0xBadCod3/badcode-patches.git
cd badcode-patches

# Build the patch package (.mpp)
